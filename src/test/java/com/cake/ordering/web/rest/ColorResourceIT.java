...
import com.cake.ordering.repository.ColorRepository;
import com.cake.ordering.service.dto.ColorDTO;
import com.cake.ordering.service.mapper.ColorMapper;
...
class ColorResourceIT {
    ...
    public static Color createEntity(EntityManager em) {
        Color color = new Color().name(DEFAULT_NAME);
        return color;
    }
    ...
    public static Color createUpdatedEntity(EntityManager em) {
        Color color = new Color().name(UPDATED_NAME);
        return color;
    }
